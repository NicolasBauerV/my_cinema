...
<body>
    <header>
        <?php 
            include '../templates/nav-bar_customer.php';
        ?>
    </header>
        ...
        <div class="link-admin">
            <?php
                if (search_admin($bdd, $_SESSION['email']) == '1') {
                    echo '
                    <span>Il semblerait que vous soyez administrateur. <a href="../admin_access_pages/admin_main.php">Cliquez ici pour vous rediriger</a></span>
                    ';
                }
            ?>
        </div>
